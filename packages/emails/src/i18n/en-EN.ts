export const EN = {
  address: 'Via Pola, 9 - 20124 Milan, Italy',
  ...
  newsletterSubscription: {
    ...
    confirmSubscription: 'Click below to confirm your subscription request:',
    activateSubscription: 'Activate your subscription',
    wrongMessage:
      'If, on the other hand, you received this message without having applied, please disregard the instructions in it.'
  },
  passwordChanged: {
    isChanged: 'account has been successfully modified. 👍',
    opening: 'the password of the',
    title: 'Password changed'
  },
  passwordExpired: {
    action: 'to reactivate it.',
    isExpired: 'account is expired.',
    opening: 'the password of the',
    security:
      'After this period the account will be blocked for security reasons. You will need to',
    support: 'contact our support',
    title: 'Password expired',
    updatePassword:
      "It's easy to change the password: you should sign in and follow the intructions."
  },
  passwordExpiring: {
    follow: 'and follow the',
    isExpiring: 'account is expiring.',
    opening: 'the password of the',
  ...
  passwordRecovery: {
    advice: 'click the button below to recovery your password.',
    btnRecovery: 'Password recovery',
    expireDate: 'The link is valid 24 hours.',
    securityAdvice: 'if you have not requested the password recovery session.',
    title: 'Password recovery'
  },
  passwordReset: {
    opening: 'the administrator has requested a password reset for the account',
    suggestions: 'Next time you log in, use the credentials below:',
