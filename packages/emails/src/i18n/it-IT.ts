export const IT = {
  address: 'Via Pola, 9 - 20124 Milano',
  ...
  newsletterSubscription: {
    ...
    greetingMessage: 'Grazie per aver scelto il nostro servizio.',
    confirmSubscription:
      'Per confermare la tua richiesta di iscrizione, clicca qui in basso:',
    activateSubscription: "Attiva l'iscrizione",
    wrongMessage:
      'Se invece hai ricevuto questo messaggio senza aver fatto richiesta, ti invitiamo ad ignorare le istruzioni in esso contenute.'
  },
  passwordChanged: {
    isChanged: 'è stata modificata con successo. 👍',
    opening: "la password dell'utenza",
    title: 'Avviso cambio password'
  },
  passwordExpired: {
    action: '',
    isExpired: 'è scaduta.',
    opening: "la password dell'utenza",
    security:
      "Dopo questo periodo l'account sarà bloccato per motivi di sicurezza. Per riattivarlo dovrai",
    support: 'contattare il nostro supporto.',
    title: 'Password scaduta',
    updatePassword:
      "Per aggiornare la password è sufficiente effettuare l'accesso:"
  },
  passwordExpiring: {
    follow: 'e segui le',
  ...
  passwordRecovery: {
    advice:
      'per procedere con il recupero della password clicca il bottone in basso.',
    btnRecovery: 'Recupero password',
    expireDate: 'Il link è valido 24h dal ricevimento di questa comunicazione.',
    securityAdvice:
      'se non sei stato tu a richiedere la procedura di recupero password.',
    title: 'Recupero password'
  },
  passwordReset: {
    opening:
      "l'amministratore ha richiesto un ripristino della password per l'utenza",
    suggestions:
      'Al prossimo accesso, utilizza le credenziali fornite di seguito:',
