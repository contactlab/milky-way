...
describe('clab-logo', () => {
  it('renders logo logo with standard color palette', async () => {
            ...
            >
              <g data-name="logo-mc-full">
                <g data-name="mc-full-typo">
                  ...
                  <polygon
                    class="st0"
                    points="325.6,42.5 333.4,10.1 324.2,10.1 316.4,42.5"
                  />
  ...
  it('renders logo logo with positive color palette', async () => {
    const {root} = await newSpecPage({
      components: [Logo],
  ...
  it('renders logo with negative color palette', async () => {
    const {root} = await newSpecPage({
      components: [Logo],
  ...
  it('renders logo with custom color palette', async () => {
    const {root} = await newSpecPage({
      components: [Logo],
  ...
  it('renders logo in compact mode', async () => {
    const {root} = await newSpecPage({
      components: [Logo],
            ...
            >
              <g data-name="logo-mc-compact">
                <g data-name="mc-compact-typo">
                  ...
                  <polygon
                    class="st0"
                    points="203.6,42.5 211.4,10.1 202.2,10.1 194.4,42.5"
                  />
  ...
  it('renders legacy logo when type is "developer"', async () => {
    const {root} = await newSpecPage({
      components: [Logo],
      html: '<clab-logo type="developer"></clab-logo>'
    });

    expect(root).toEqualHtml(`
      <clab-logo type="developer">
        <mock:shadow-root>
          <clab-legacy
            fillstyle="positive"
            fillcolor="black"
  ...
  it('renders legacy logo when type is "explore"', async () => {
    const {root} = await newSpecPage({
      components: [Logo],
      html: '<clab-logo type="explore"></clab-logo>'
    });

    expect(root).toEqualHtml(`
      <clab-logo type="explore">
        <mock:shadow-root>
          <clab-legacy
            fillstyle="positive"
            fillcolor="black"
