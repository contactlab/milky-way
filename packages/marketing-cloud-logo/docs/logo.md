...
| compact    | `boolean`                                             | `false`      | Use the compact version of the Marketing Cloud logo. **This attribute has effect only if you set the `type` attribute to `'mc'` (the default)**.                                                 |
